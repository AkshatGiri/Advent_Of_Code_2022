...
compartments.forEach((comp) => {
  // split the comp string into 2 equal parts
  const comp1 = comp.slice(0, comp.length / 2)
  const comp2 = comp.slice(comp.length / 2)
  // find common character between the 2 parts
